...
const neo4j = require('neo4j-driver'); //require('neo4j-driver').v1;
...
export default class Neo4jController {
    ...
    constructor(options: Neo4jControllerOptions) {
        ...
        this.driver = neo4j.driver(options.connection.url, neo4j.auth.basic(options.connection.user, options.connection.password));
    }
